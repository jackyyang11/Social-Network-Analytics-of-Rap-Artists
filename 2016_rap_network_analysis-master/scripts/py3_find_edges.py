# -*- coding: utf-8 -*-
"""
Created on Sat Dec  8 18:43:55 2018
...
def find_album(album_name, artist_name):
    search_url = 'https://api.spotify.com/v1/search?q=album:{}%20artist:{}&type=album'.format(urllib.parse.quote_plus(album_name),urllib.parse.quote_plus(artist_name))
    print(search_url)
